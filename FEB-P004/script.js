...
botoesComprar.forEach(function (botao) {
  botao.addEventListener("click", function () {
    ...
    var destino =
      this.parentElement.querySelector(".roteiro-destino").textContent;
    var inclusos = Array.from(
      this.parentElement.querySelectorAll(".roteiro-incluso li")
    ).map(function (item) {
      return item.textContent;
    });
    var preco = this.parentElement.querySelector(".roteiro-preco").textContent;
    var observacoes =
      this.parentElement.querySelector(".roteiro-obs").textContent;
    var parcelamento = this.parentElement.querySelector(
      ".roteiro-parcelamento"
    ).textContent;
