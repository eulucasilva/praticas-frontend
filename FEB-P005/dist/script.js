...
function getWeatherForecast() {
    var apiKey = 'dfc6e6f95cb1b848d967fa9239a0fbae';
    var cidade = 'Ilheus';
    return new Promise(function (resolve, reject) {
        fetch("https://api.openweathermap.org/data/2.5/weather?q=".concat(cidade, "&appid=").concat(apiKey))
            .then(function (response) { return response.json(); })
            .then(function (data) {
            if (data.weather && data.weather.length > 0) {
                var description = data.weather[0].description;
                resolve("A previs\u00E3o do tempo em ".concat(cidade, " \u00E9: ").concat(description));
            }
            else {
...
function preencherQuadroServicos() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    quadroServicosElement = document.querySelector('.servicos h3');
                    previsaoTempoElement = document.createElement('p');
                    previsaoTempoElement.id = 'previsao-tempo';
                    if (!quadroServicosElement) return [3 /*break*/, 5];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, getWeatherForecast()];
                case 2:
                    previsaoTempo = _a.sent();
